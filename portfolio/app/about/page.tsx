        ...
        <div className="text-left max-w-screen-xl px-4 sm:px-8 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-8">
            ...
            <p
              ...
              style={{ lineHeight: '2' }}
            >
              I’m a student studying Computer Science with an emphasis in
              Software Engineering and Cybersecurity. One thing you should know
              is that I am coffee lover - one espresso macchiato please!
            </p>
